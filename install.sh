...
declare -r browser_certs_cmd="/usr/bin/sudo /usr/bin/cp -pv ${pdir}/certs/selfsigned.crt /usr/local/share/ca-certificates/ && /usr/bin/sudo /usr/sbin/update-ca-certificates"
